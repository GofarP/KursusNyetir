...
<body>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('pelatih.store')}}" class="mb-5"  enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    <input type="submit" class="form-control btn btn-primary mt-3" value="Tambah Pelatih" style="border-radius:100px">
                </div>
