...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <h3 class="mt-3">Daftar Pelatih</h3>

                <div class="d-flex  justify-content-end">
                    <div>
                        <a href="{{route('pelatih.create')}}" class="btn btn-success mt-3"><i class="bi bi-plus-circle"></i> Tambah Kelas</a>
                    </div>
                </div>
                        ...
                        <tbody>
                           ...
                           @foreach ($pelatih as $pelatih )
                                <tr>
                                    ...
                                    <td>{{$pelatih->notelp}}</td>
                                    <td>{{$pelatih->tempat_lahir}}, {{$pelatih->tanggal_lahir}}</td>
                                    <td>{{$pelatih->alamat}}</td>
                                    <td>
                                        <img class="img-preview img-fluid mt-3 mb-3 col-sm-5" src="{{ asset('storage/' . $pelatih->foto) }}" style="width:50%;height:50%">
                                    </td>
                                    <td>
                                        <a class="btn btn-warning" href="{{route('pelatih.edit',$pelatih)}}">
                                            <i class="bi bi-pencil"></i>
                                            Edit
                                        </a>
                                        <form action="{{route('pelatih.destroy',$pelatih)}}" method="POST"
