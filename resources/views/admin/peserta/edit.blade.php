...
<body>
    ...
    @section('content')
        ...
        <form method="post" action="{{route('peserta.update',$peserta->id_peserta)}}" class="mb-5"  enctype="multipart/form-data">
            @csrf
            @method("PUT")
            <div class="mb-3">
                <label for="nama" class="mt-3 mb-2">Nama Peserta:</label>
                <input type="text" name="nama" placeholder="Masukkan Nama Peserta"
                    class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama',$peserta->nama) }}">
                    @error('nama')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="alamat" placeholder="Masukkan Alamat Peserta"
                    class="form-control @error('alamat') is-invalid @enderror" value="{{ old('alamat',$peserta->alamat) }}">
                    @error('alamat')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="notelp" placeholder="Masukkan NoTelp Peserta"
                    class="form-control @error('notelp') is-invalid @enderror" value="{{ old('notelp',$peserta->notelp) }}">
                    @error('notelp')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="tempat_lahir" placeholder="Masukkan Tempat Lahir Peserta"
                    class="form-control @error('tempat_lahir') is-invalid @enderror" value="{{ old('tempat_lahir',$peserta->tempat_lahir) }}">
                    @error('tempat_lahir')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group date" id="datepicker">
                    ...
                    <input type="text" name="tanggal_lahir" id="tanggal_lahir" class="form-control @error('tanggal_lahir') is-invalid @enderror"
                     value="{{old('tanggal_lahir',$peserta->tanggal_lahir)}}" placeholder="Tanggal-Bulan-Tahun" readOnly="true">
            ...
            <div class="mb-3">
                <input type="submit" class="form-control btn btn-primary mt-3" value="Edit Peserta" style="border-radius:100px">
            </div>
